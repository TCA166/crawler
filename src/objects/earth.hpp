...
inline earth::earth(shader* target_shader, double xpos, double ypos, double zpos) : game_object(target_shader, "models/earth.obj", earth_mass, glm::vec3(0.0, 0.0, INITIAL_VELOCITY(sun_mass, earth_sun_distance)), xpos, ypos, zpos), ground(texture("textures/ground.jpg")), ground_normal(texture("textures/ground_normal.png")), night(texture("textures/night.jpg")), clouds(texture("textures/clouds.png")){
