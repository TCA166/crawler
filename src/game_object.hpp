...
public:
  ...
  */
  game_object(const shader *object_shader, const std::string &path, double mass,
              glm::vec3 velocity, double xpos, double ypos, double zpos);
  virtual ~game_object();
  /*!
...
/*!
 ...
 @note Naturally you can always invert the force to get the force exerted by
 obj2 on obj1, but the argument order is important
*/
...
/*!
 ...
 @note This function will apply the forces to the objects in the list, you must
 evaluate the objects after calling this function
*/
